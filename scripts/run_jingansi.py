"""Entry point: Jingansi video — parallel-line + pass-region detection."""
...
# Paths
# ---------------------------------------------------------------------------
VIDEO_PATH = r"\\10.151.2.205\共享文件2\短视频\静安寺\clipped_segments\静安寺2.mp4"  # TODO: fill in video path
